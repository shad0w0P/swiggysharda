...
public class App {
    ...
    App()
    {
        ...
        this.user = new User("Atul Pandey",userLocation);
    }
    ...
    public void parseRestroData() throws IOException{
        BufferedReader restroData=Files.newBufferedReader(Paths.get("data\\restro.csv"));
        String lines=null;
    ...
    public void parseDishData() throws IOException{
        BufferedReader dishData=Files.newBufferedReader(Paths.get("data\\dish.csv"));
        String lines=null;
    ...
    public void parseLocationData() throws IOException{
        BufferedReader locationData=Files.newBufferedReader(Paths.get("data\\location.csv"));
        String lines=null;
